    ...
    <div>
      ...
      <section className="container py-md-3 py-3 d-flex justify-content-start">
        <div id="subheading">
          <h2 className="sub_heder ">
            Experience Tapas <span className="sub_span text-black"> Holistic Health Systems</span>
          </h2>
      ...
      <section className="sect4 container pt-4 pt-md-4  text-center">
        <div className="sect4div">
            <h2>Our <span className="sect4span">Services</span> </h2>
            <p className="sect4par">Are You Ready to meet a healthier you.....?</p>
            <div className="line2"></div>
            <p className="sect4par2">We customize an “ Integrative health plan” for you , utilizing all the required holistic therapies mentioned below as per three dimensions -body, mind, energy(Qi) constitution. Helping you reach your wellness goals.</p>
        </div>
      </section>
      ...
      <section className="sect7 container py-3 py-md-3 ">
         <div className="sect7div text-center">
            ...
            <p className="sect7par">Very important objective effects produced by Acupuncture:</p>
         </div>
      </section>
      <section className="sect7 container py-3 py-md-3">
        <div className="row">
        <div className="col-md-4">
            <div>
                ...
                <p className="sect8par">Body’s resistant power of body is increased by acupuncture by increase of leucocytosis ,antibodies, gamma globulins etc. Thats why acupuncture is very effective in treating infections also in the cases of resistance or hypersensitivity to antibiotics or where antibiotics have failed or given serios side effects .Also prolonged use of antibiotics can be reduced with concurrent use of Acupuncture.</p>
            </div>
            <div>
                <h3 className="py-2 text-center sect8h3 ">Analgesic(Pain relief)</h3>
                <p className="sect8par">Selected points give pain relief from tooth ache,back pain, headache, arthritis pain,injury, nerve pain and other similar pain disorders .Secretion of endorphis, serotonin is involved in acupuncture analgesia .Opiate and non opiate neuro-transmitters ,hormonal mechanisms are involved in pain relief with Acupuncture.</p>
            </div>
            <div>
                <h3 className="py-2 text-center sect8h3 ">Psychological Effect</h3>
                <p className="sect8par">Calming and tranquilizing effect of acupuncture .Measurable effects have been reported in the metabolic activity of brain tissue.eg-there is an increase of Dopamine content of the brain after acupuncture that’s why it is very effective in treating in certain mental disorders like Parkinson’s where depletion of dopamine content in brain.</p>
            </div>
        </div>
        ...
        <div className="col-md-4">
            <div>
                ...
                <p className="sect8par">Needling of certain points results in sedation. its shown that during acupuncture there is a decrease in delta and theta wave activity on the electro-encephalogram. thats why its effective in treating insomnia,anxiety ,epilepsy, addictions, behavioural mental disorders.</p>
            </div> 
            <div>
                <h3 className="py-2 text-center sect8h3 ">Motor recovery(Brain)</h3>
                <p className="sect8par">Acupuncture hastens the motor recovery in cases who have become paralysed .late cases of motor failure also responds well to acupuncture despite failure of other forms of therapies.to know more about this check-(motor gate theory :Jayasuriya and Fernando ,paper represented at the fifth world congress on acupuncture,Tokyo,1977)</p>
            </div> 
            <div>
                <h3 className="py-2 text-center sect8h3 ">Homeostatic Effect</h3>
                <p className="sect8par">Restoring the original state of equilibrium by affecting the parasympathetic and sympathetic nervous system and endocrine system.these systems are disturbed in many ailments so use of acupuncture helps bringing the internal balance and treating these disorders.Acupuncture activates many of the body’s Self Healing Mechanisms.</p>
            </div> 
        </div>
        </div>
      </section>
      ...
      <section className="sect10 container py-3 py-md-3">
        <div className="row">
          <div className="col-md-12 text-center">
            <h1 className="sect10h2">Therapeutic <span className="sect10span">Yoga</span> </h1>
            <h4>Yoga is the journey of the self, to the self, through the self.</h4>
        ...
        <div className="row">
          <div className="col-md-12 text-center">
            ...
            <div className="sect11div">
              ...
              <p>Our therapeutic yoga specialist can pull from all forms of yoga and a broad spectrum of yoga pose to design a program that fits best for your needs.Our trust is through these teachings you will find more ease in your body, tranquil mind, and greater levels of energy and well-being.</p>
              <p>We have different therapeutic yoga programs to help to ease conditions like arthritis, back pain, neck pain,muscular issues,insomnia,sciatica,all types of headaches,gastrointestinal issues, weight gain ,hormonal imbalance-thyroid conditions, mental issues like depression, anxiety also pre and postnatal yogic care.these are just to name the few ,please consult for your needs and goals.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="sect12 container py-4 py-md-4">
        <div className="text-center my-2">
          <h2>EFFECTS OF STRESS ON <span className="sect10span">HUMAN BODY</span></h2>
          <div className="linesect10"></div>
        </div>
      <div className="row gy-3 mt-4">
        <div className="col-md-4">
           <div>
                ...
                <p className="sect12par">Prolonged stress is the reason for depression, anxiety ,panic attacks, memory loss, mood swings ,insomnia ,mindfog.</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Respiratory System</h4>
                <p className="sect12par">Hormonal imbalance, menstrual disorders, fertility issues in women - low egg quality ,endometriosis and also in men like chronic stress can impair testosterone and sperm production and can cause impotence.</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Musculoskeletal system</h4>
                <p className="sect12par">Increased inflammation in musculoskeletal system, aches, tension ,muscle tightness ,more prone to injuries, muscular twitches and tics.</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Immune System</h4>
                <p className="sect12par">Due to chronic stress low immunity ,increased risk of falling sick frequently ,longer recovery time.</p>
           </div>
        </div>
        <div className="col-md-4">
        ...
        <div className="col-md-4">
          <div>
                ...
                <p className="sect12par">Stress is also the reason for skin issues like Eczema, psoriasis, delayed tissue repair, Acne and dull skin etc. Hair fall and baldness is very common in cases of severe stress.</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Cardiovascular system</h4>
                <p className="sect12par">Imbalance in blood pressure, increased rate of heart attack ,stroke and other heart related issues.</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Reproductive System</h4>
                <p className="sect12par">High level of stress adversely affects patients of asthma ,hyperventilation etc</p>
           </div>
           <div>
                <h4 className="py-1 text-center sect8h3 ">Respiratory System</h4>
                <p className="sect12par">Hormonal imbalance, menstrual disorders, fertility issues in women - low egg quality ,endometriosis and also in men like chronic stress can impair testosterone and sperm production and can cause impotence.</p>
      ...
      <section className="container-fluid pb-4" id="section-last">
       ...
       <div className="btndiv text-center mt-4">
        <Link to='/Testimonials' className="btn btn-primary text-white">Know more</Link>
       </div>
      </section>
      </div>
  );
